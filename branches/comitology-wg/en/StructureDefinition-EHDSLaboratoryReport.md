...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/eu.ehds.models|current/StructureDefinition/StructureDefinition-EHDSLaboratoryReport.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-06-06T19:09:24+00:00",
  "publisher" : "EC",
  "contact" : [{
    "name" : "EC",
    "telecom" : [{
  ...
  "differential" : {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.eventCategory",
      "path" : "EHDSLaboratoryReport.header.eventCategory",
      "binding" : {
        "strength" : "preferred",
