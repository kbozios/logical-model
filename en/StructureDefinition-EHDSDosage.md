...
EHDSDosage means a structured set of data elements describing the instructions for administering a medicinal product. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/eu.ehds.models|current/StructureDefinition/StructureDefinition-EHDSDosage.json)
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "EHDSDosage",
      "short" : "Dosage model",
      "definition" : "EHDSDosage means a structured set of data elements describing the instructions for administering a medicinal product."
    },
    {
    ...
    },
    {
      ...
      "short" : "Frequency of intake/administration.",
      "definition" : "Frequency of intake/administration.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Base"
