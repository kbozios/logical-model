...
* header 1..1 Base "Basic metadata for this information"
  ...
  * author[x] 0..* EHDSHealthProfessional or EHDSOrganisation or EHDSDevice "Author of the resource." """Author(s) responsible for the provided information. The exact role of the responsible author varies across use cases and is specific to individual models."""
